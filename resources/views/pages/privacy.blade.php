...
<div class="container py-5">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4 p-md-5">
            ...
            <p>GETREADY ("we," "us," or "our") is committed to safeguarding your privacy online. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website www.getready.co.in or use our mobile applications.</p>
            ...
            <h5 class="mt-4">2. How We Use Collected Information</h5>
            <p>GETREADY may collect and use Users' personal information for the following purposes:</p>
            <ul>
            ...
            <h5 class="mt-4">3. How We Protect Your Information</h5>
            <p>We adopt appropriate data collection, storage and processing practices and security measures to protect against unauthorized access, alteration, disclosure or destruction of your personal information, username, password, transaction information and data stored on our Site.</p>

            <h5 class="mt-4">4. Sharing Your Personal Information</h5>
            <p>We do not sell, trade, or rent Users' personal identification information to others. We may share generic aggregated demographic information not linked to any personal identification information regarding visitors and users with our business partners, trusted affiliates and advertisers for the purposes outlined above.</p>

            <h5 class="mt-4">5. Third-Party Websites</h5>
            ...
            <p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at: <a href="mailto:care@Getready.co.in">care@Getready.co.in</a>.</p>
        </div>
    </div>
</div>
@endsection
